...
def seeded_pm_hierarchy():
    ...
    family = db.PUMaterialFamily(plant_id=plant.id, name=f"PM Hierarchy Smoke Family {u}")
    ...
    grade = db.FoamGrade(pu_material_family_id=family.id, grade_name=f"PM Hierarchy Smoke Grade {u}")
