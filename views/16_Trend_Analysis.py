...
render_function_action_intro(
    function_text=(
        ...
        "a whole PU Material Family pooled together): an individuals control chart with real control "
    ...
    action_text=(
        ...
        "flags, use 'Ask PI3' to get it interpreted against recipe changes, equipment / machine "
        "changes, and quality-issue history before acting on it. Download the Trend Analysis "
        "Report further "
